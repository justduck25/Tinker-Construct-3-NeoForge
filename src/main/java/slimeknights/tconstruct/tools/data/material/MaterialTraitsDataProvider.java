...
public class MaterialTraitsDataProvider extends AbstractMaterialTraitDataProvider {
  ...
  public String getName() {
    return "Continuum Construct Material Traits";
  }
  ...
  protected void addMaterialTraits() {
    ...
    addTraits(MaterialIds.gold, PlatingMaterialStats.SHIELD.getStatsId(), ModifierIds.magicProtection);
    ...
    // slimecage
    MaterialStatsId cage = RepairStats.RIBCAGE.getStatsId();
