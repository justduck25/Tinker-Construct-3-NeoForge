...
/**
 * This class handles all tool part sprites generated by Continuum Construct. You can freely use this in your addon to generate TiC part textures for a new material
...
public class TinkerPartSpriteProvider extends AbstractPartSpriteProvider {
  ...
  public String getName() {
    return "Continuum Construct Parts";
  }
  ...
  protected void addAllSpites() {
    ...
    buildTool("armor/travelers/goggles").disallowAnimated()
      ...
      .addBreakablePart("metal", PlatingMaterialStats.HELMET.getStatsId());
    buildTool("armor/travelers/vest").disallowAnimated()
      .addBreakablePart("cuirass", StatlessMaterialStats.CUIRASS.getIdentifier())
      .addBreakablePart("metal", PlatingMaterialStats.CHESTPLATE.getStatsId());
    buildTool("armor/travelers/pants").disallowAnimated()
      .addBreakablePart("cuirass", StatlessMaterialStats.CUIRASS.getIdentifier())
      .addBreakablePart("metal", PlatingMaterialStats.LEGGINGS.getStatsId());
    buildTool("armor/travelers/boots").disallowAnimated()
      .addBreakablePart("cuirass", StatlessMaterialStats.CUIRASS.getIdentifier())
      .addBreakablePart("metal", PlatingMaterialStats.BOOTS.getStatsId());
    ...
    for (ArmorType slot : ModifiableArmorMaterial.ARMOR_TYPES) {
      buildTool("armor/plate/" + slot.getName()).disallowAnimated() // the armor model won't be animated, so don't animate the item
        .addBreakablePart("plating", PlatingMaterialStats.TYPES.get(slot.ordinal()).getStatsId())
    ...
    buildTool("armor/plate/shield")
      .addBreakablePart("plating", PlatingMaterialStats.SHIELD.getStatsId())
      ...
      .addBreakablePart("plating_large", PlatingMaterialStats.SHIELD.getStatsId())
    ...
    buildTool("armor/slime").disallowAnimated()
      ...
      .addBreakablePart("chestplate/ribcage", RepairStats.RIBCAGE.getStatsId())
      .addBreakablePart("leggings/slime",     SlimeStats.ID)
      .addBreakablePart("leggings/shell",     RepairStats.SHELL.getStatsId())
      .addBreakablePart("boots/slime",        SlimeStats.ID)
      .addBreakablePart("boots/laces",        RepairStats.LACES.getStatsId())
    ...
    // ancient tools
    buildTool("melting_pan").skipVariants().addBreakablePart("head", PlatingMaterialStats.SHIELD.getStatsId()).addLimb("handle");
    buildTool("war_pick").skipVariants().addHead("limb").addLimb("body")
                         .addBreakableBowstring("bowstring").addBowstring("bowstring_1").addBowstring("bowstring_2").addBowstring("bowstring_3");
    buildTool("battlesign").skipVariants().addBreakableHead("head").addPart("handle", PlatingMaterialStats.SHIELD.getStatsId());
