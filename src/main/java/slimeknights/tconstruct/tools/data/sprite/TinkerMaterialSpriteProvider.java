...
/**
 * This class handles all materials generated by Continuum Construct. You can freely use this in your addon to generate TiC material textures for a new tool
  ...
  protected void addAllMaterials() {
    ...
    buildMaterial(MaterialIds.ice)
      ...
      .transformer(GreyToSpriteTransformer.builderFromBlack()
        .addTexture(63, Identifier.withDefaultNamespace("block/blue_ice"))
        .addTexture(102, Identifier.withDefaultNamespace("block/packed_ice"))
        .addTexture(140, Identifier.withDefaultNamespace("block/ice"))
        .build());
