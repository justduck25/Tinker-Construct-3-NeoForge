...
public class ToolDefinitionDataProvider extends AbstractToolDefinitionDataProvider {
  ...
  protected void addToolDefinitions() {
    ...
    define(ToolDefinitions.PICKAXE)
      ...
      // harvest
      .module(ToolActionsModule.of(ItemAbility.get("pickaxe_dig")))
    ...
    define(ToolDefinitions.MATTOCK)
      ...
      // harvest
      .module(ToolActionsModule.of(ItemAbility.get("axe_dig"), ItemAbility.get("shovel_dig")))
    ...
    define(ToolDefinitions.PICKADZE)
      ...
      // harvest
      .module(ToolActionsModule.of(ItemAbility.get("pickaxe_dig"), ItemAbility.get("shovel_dig")))
    ...
    define(ToolDefinitions.EXCAVATOR)
      ...
      // harvest
      .module(ToolActionsModule.of(ItemAbility.get("shovel_dig")))
    ...
    define(ToolDefinitions.HAND_AXE)
      ...
      // harvest
      .module(ToolActionsModule.of(ItemAbility.get("axe_dig"), TinkerToolActions.SHIELD_DISABLE))
    ...
    define(ToolDefinitions.KAMA)
      ...
      // harvest
      .module(ToolActionsModule.of(ItemAbility.get("hoe_dig")))
    ...
    define(ToolDefinitions.DAGGER)
      ...
      // behavior
      .module(ToolActionsModule.of(ItemAbility.get("sword_dig"), ItemAbility.get("hoe_dig")))
    ...
    define(ToolDefinitions.SWORD)
      ...
      .module(ToolActionsModule.of(ItemAbility.get("sword_dig")))
      // behavior
      .module(swordHarvest)
    ...
    defineArmor(ArmorDefinitions.TRAVELERS)
      ...
      .module(ArmorType.BOOTS, ToolTraitsModule.builder().trait(ModifierIds.snowBoots).build())
      // faster tool name logic
      .module(FixedMaterialToolName.FIRST);
    ...
    defineArmor(ArmorDefinitions.SLIMESUIT)
      ...
      .module(ArmorType.HELMET, new CustomMaterialName(0, "skull"))
      // for non-helmets, we want the direct mateiral name
      .module(FixedMaterialToolName.FIRST, ArmorType.CHESTPLATE, ArmorType.LEGGINGS, ArmorType.BOOTS);
    define(ArmorDefinitions.SLIME_WINGS)
      ...
      .module(ToolSlotsModule.builder()
          ...
          .slots(SlotType.ABILITY, 1).build())
      .module(MaterialRepairModule.of(MaterialIds.phantom, ArmorType.CHESTPLATE, 42))
      // traits
    ...
    define(ToolDefinitions.MELTING_PAN)
      // parts
      .module(MaterialStatsModule.stats()
        .stat(PlatingMaterialStats.SHIELD.getStatsId())
    ...
    define(ToolDefinitions.BATTLESIGN)
      ...
      .module(ancientTwoParts)
      // ancient tools when rebalanced get both heads
      .module(new MaterialTraitsModule(PlatingMaterialStats.SHIELD.getStatsId(), 1), ToolHooks.REBALANCED_TRAIT)
      // stats
      .module(new SetStatsModule(StatsNBT.builder()
