...
public class StationSlotLayoutProvider extends AbstractStationSlotLayoutProvider {
  ...
  public StationSlotLayoutProvider(PackOutput packOutput, CompletableFuture<HolderLookup.Provider> lookupProvider) {
    super(packOutput);
  ...
  protected void addLayouts() {
    var itemRegistry = lookupProvider.join().lookupOrThrow(net.minecraft.core.registries.Registries.ITEM);
    Ingredient modifiable = Ingredient.of(itemRegistry.getOrThrow(TinkerTags.Items.MODIFIABLE));
  ...
  public String getName() {
    return "Continuum Construct Tinker Station Slot Layouts";
  }
}
