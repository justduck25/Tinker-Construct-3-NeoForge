...
public class MenuTypeTagProvider extends BuiltinRegistryTagProvider<MenuType<?>> {
  ...
  public MenuTypeTagProvider(PackOutput packOutput, CompletableFuture<Provider> lookupProvider) {
    super(packOutput, BuiltInRegistries.MENU, lookupProvider, TConstruct.MOD_ID);
  }
  ...
  public String getName() {
    return "Continuum Construct Menu Type Tags";
  }
}
