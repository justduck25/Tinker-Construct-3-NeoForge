...
public class FluidTagProvider extends FluidTagsProvider {
  ...
  protected void addTags(Provider pProvider) {
    ...
    this.tag(MantleTags.Fluids.SOUP).addTag(TinkerFluids.meatSoup.getTag()).addOptionalTag(TagKey.create(Registries.FLUID, TinkerTags.Fluids.SOUP_TOOLTIPS.location()));
