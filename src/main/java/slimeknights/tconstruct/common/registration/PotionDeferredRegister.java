...
public class PotionDeferredRegister extends DeferredRegisterWrapper<Potion> {
  ...
  /** Registers a group of potions with the same effect */
  public Builder registerTypes(DeferredHolder<? extends MobEffect, ? extends MobEffect> effect, int duration, int amplifier) {
  ...
  public Builder registerTypes(DeferredHolder<? extends MobEffect, ? extends MobEffect> effect) {
